...
{
    // Verifica se é uma estrutura ou uniao
    ...
    // verifica se comeca com um ponteiro ou não
    else if (is_pointer())
    {
        adicionarElemento(tipoTokenActual);
        tipoTokenActual = analex(ficheiro);
        if (is_identifier())
        {
            strcpy(tipoTokenActual.tipoVariavel, tipoVariavelActual);
            adicionarElemento(tipoTokenActual);
            tipoTokenActual = analex(ficheiro);
            declaration1();
        }
    ...
    {
        // Erro: estrutura ou união esperada
    }
}
...
bool is_identifier()
{
    if (strcmp(tipoTokenActual.token, TK_ID) == 0)
    {
        return true;
    }
    else
...
{
    if (strcmp(tipoTokenActual.lexema, "auto") == 0 ||
        strcmp(tipoTokenActual.lexema, "static") == 0 ||
        strcmp(tipoTokenActual.lexema, "extern") == 0)
    {
        strcat(tipoVariavelActual, " ");
        strcat(tipoVariavelActual, tipoTokenActual.lexema);
        return true;
    }
    else
    {
...
bool is_type_specifier()
{
    ...
    if (strcmp(tipoTokenActual.lexema, "void") == 0 ||
        strcmp(tipoTokenActual.lexema, "char") == 0 ||
        strcmp(tipoTokenActual.lexema, "short") == 0 ||
        strcmp(tipoTokenActual.lexema, "int") == 0 ||
        strcmp(tipoTokenActual.lexema, "long") == 0 ||
        strcmp(tipoTokenActual.lexema, "float") == 0 ||
        strcmp(tipoTokenActual.lexema, "double") == 0 ||
        strcmp(tipoTokenActual.lexema, "signed") == 0 ||
        strcmp(tipoTokenActual.lexema, "unsigned") == 0 ||
        strcmp(tipoTokenActual.lexema, "enum") == 0 ||
        strcmp(tipoTokenActual.lexema, "typedef") == 0)
    {
        strcat(tipoVariavelActual, " ");
        strcat(tipoVariavelActual, tipoTokenActual.lexema);
        return true;
...
{
    if (strcmp(tipoTokenActual.lexema, "const") == 0 ||
        strcmp(tipoTokenActual.lexema, "volatile") == 0)
    {
        strcat(tipoVariavelActual, " ");
        strcat(tipoVariavelActual, tipoTokenActual.lexema);
        return true;
...
{
    if (strcmp(tipoTokenActual.token, TK_AC) == 0)
    {
        adicionarElemento(tipoTokenActual);
        tipoTokenActual = analex(ficheiro);
        struct_declaration();
...
void struct_fim()
{
    if (strcmp(tipoTokenActual.token, TK_ID) == 0)
    {
        ...
        if (strcmp(tipoTokenActual.token, TK_PV) == 0)
        {
            adicionarElemento(tipoTokenActual);
            tipoTokenActual = analex(ficheiro);
            return;
    ...
    else if (strcmp(tipoTokenActual.token, TK_PV) == 0)
    {
        // Processar o ponto e vírgula
        return;
    }
    else
    {
        // Erro: identificador ou ponto e vírgula esperado
        return;
    }
}
...
{
    if (strcmp(tipoTokenActual.lexema, "struct") == 0)
    {
        strcat(tipoVariavelActual, tipoTokenActual.lexema);
        return true;
    }
    else if (strcmp(tipoTokenActual.lexema, "union") == 0)
    {
        strcat(tipoVariavelActual, tipoTokenActual.lexema);
        return true;
    }
...
void specifier_qualifier()
{
    ...
    {
        // Erro: especificador ou qualificador inválido
    }
}
...
void struct_declarator()
{
    ...
    {
        // Erro: declarador ou dois pontos esperados
    }
}

void struct_declarator1()
{
    if (strcmp(":", tipoTokenActual.lexema) == 0)
    {
        constant_expression();
    }
    else
...
void pointer()
{
    if (is_asterisk_operator())
    {
        // Pode haver type-qualifiers opcionais
        while (is_type_qualifier())
        {
            // Processar type-qualifier
        }
        pointer();
    }
    else
